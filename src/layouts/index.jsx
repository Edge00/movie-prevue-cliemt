...
import { SroreConsumer } from '../store'
...
class Layout extends Component {
  constructor(props) {
    super(props)
    this.matchRouteNme = this._getMatchRouteName()
  }

  render() {
    const { loading, tip } = this.props.store.data.index
    return (
...
export default SroreConsumer(Layout)
